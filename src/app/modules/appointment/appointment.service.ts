...
const getMyAppointment = async(user:any,options:any,filters:any)=>{
...
const updateAppointmentStatus = async(appointmentId:string,status:AppointmentStatus,user:any)=>{
    const appointmentData = await prisma.appointment
    .findUniqueOrThrow({
        where:{
            id:appointmentId
        },
...
const getAllFromDB = async (
    ...
    const { limit, page, skip } = paginationHelper.calculatedPagination(options);
